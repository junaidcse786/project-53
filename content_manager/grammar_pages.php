...
$sql = "SELECT * FROM ".$db_suffix."content where content_permalink='1' ORDER BY content_id ASC";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                <?php echo $menus["$mKey"]["$pKey"]; ?> <small>The list of grammar pages already created</small>
                                        </h3>
                               <div class="page-bar">         
            ...
            <div class="col-md-12">
               ...
               <div class="portlet box grey-cascade">
                  <div class="portlet-title">
                     <div class="caption"><i class="fa fa-table"></i>Content</div>
                     <div class="actions">
                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=addcontent'; ?>" class="btn blue"><i class="fa fa-plus"></i> Add new content</a>
                        <div class="btn-group">
		   ...
		   ?>
                           ...
                           <tr class="odd gradeX">
                              <td><input type="checkbox" class="checkboxes" value="<?php echo $row->content_id;?>" /></td>
                              <td><a href="<?php echo '?mKey='.$mKey.'&pKey=editcontent&id='.$row->content_id;?>"><?php echo $row->content_title;?></a></td>
                              
                              <td>
							  <?php if($row->content_published)
    ...
    <script>
				...
				$('#confirmation_all').on('show.bs.modal', function(e) {
					 ...
					 $('input:checkbox[class=checkboxes]:checked').each(function(){
						...
						$.ajax({
							   type: "POST",
							   url:  '<?php echo SITE_URL_ADMIN.'content_manager/delete_content.php' ; ?>',
							   dataType: "text",
							   data: {id: id},
				...
				$('#confirmation_status').on('show.bs.modal', function(e) {
					 ...
					 var column_name='content_published';
					 
					 var column_id='content_id';
