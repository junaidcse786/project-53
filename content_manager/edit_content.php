...
$content_id = isset($_REQUEST['id']) ? $_REQUEST['id']: 0;
...
if(mysqli_num_rows($query) > 0)
{
	...
	$grammar    = $content->content_permalink;
	$parent      = $content->content_parent;
	$order       = $content->content_order;
	$published   = $content->content_published;	
	$update_date = $content->content_update_time;
}
...
{	
	...
	if($err == 0)
	{
		$sql = "UPDATE ".$db_suffix."content SET content_title = '$title',content_sub_title = '$subtitle',
		content_desc = '$description',content_meta_title = '$meta_title',content_meta_keywords = '$meta_key',content_meta_desc = '$meta_desc',content_published = '$published', content_permalink='$grammar', 
		content_parent = '$parent',content_order = '$order',content_update_time = '$update_date', content_topic='$content_topic' WHERE content_id = ".$content_id;
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Update Content <small>Here existing contents can be edited</small>
                                        </h3>
                                        <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey=content&pKey=contentlist'; ?>">Content List</a>
														<i class="fa fa-angle-right"></i>
                                                </li>
												<li>
                                                        <a  href="#">Update Content ID: <?php echo $content_id; ?></a>
                                                </li>
                                        </ul>
                          ...
                          <div class="alert alert-<?php echo $alert_type; ?> <?php echo $alert_box_show; ?>">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-4">
                                    <select class="form-control select2me"  data-placeholder="Choose a Category" tabindex="0" name="parent">
                                       ...
                                       <?php
									   $sql_parent_menu = "SELECT content_id, content_title FROM ".$db_suffix."content where content_id!='$content_id' AND content_published='1'";	
							...
							{								
                              ...
                              <br />
                                     ...
                                     <select id="exercise_type1" class="form-control input-small" name="exercise_type1">
                                     <option></option>
