...
$sql = "SELECT * FROM ".$db_suffix."content where content_permalink='0' ORDER BY content_id ASC";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                <?php echo $menus["$mKey"]["$pKey"]; ?> <small>The list of contents already created</small>
                                        </h3>
                               <div class="page-bar">         
