...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                My files <small>uploaded by the admin</small>
                                        </h3>
                               <div class="page-bar">         
		   ...
		   ?>
                           ...
                           <tr class="odd gradeX">
                              ...
                              <td><a target="_blank" href="<?php echo SITE_URL.'data/FILES/'.$user_folder.$row->gallery_file;?>"><?php echo $row->gallery_title;?></a></td>
