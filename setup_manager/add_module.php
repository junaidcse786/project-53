...
if(isset($_POST['Submit'])){
			...
			if($err == 0){	
				...
				$result = "INSERT INTO ".$db_suffix."module(module_name, module_title, module_key,module_image,module_priority,module_status, module_menu) VALUES ('$module_name', '$module_title','$module_key', '$module_image', '$module_priority',  '$module_status', '$module_menu')";
				...
				if(mysqli_query($db,$result)){
					...
					$new_module_id=mysqli_insert_id($db);
					mysqli_query($db, "INSERT INTO ".$db_suffix."module_in_role (module_id,role_id) VALUES ('$new_module_id','8')");
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Create Module <small>Here New Modules can be created</small>
                                        </h3>
                                        <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey='.$pKey; ?>">Add New Module</a>
                                                </li>
                                        </ul>
