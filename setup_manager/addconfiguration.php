...
{	
	...
	if($err == 0)
	{
		...
		$sql = "INSERT INTO ".$table_name." ( config_name, config_value, config_note ) VALUES ('$config_name', '$config_value', '$config_note' )";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Add Configuration <small>Here New Configurations can be created</small>
                                        </h3>
                                        <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey='.$pKey; ?>">Add Configuration</a>
                                                </li>
                                        </ul>
