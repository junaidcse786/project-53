...
if(isset($_POST['Submit'])){	
	...
	if($err == 0){
		...
		$sql_roll = "INSERT INTO ".$db_suffix."role (role_title,role_desc,role_status) 
		VALUES ('$role_title', '$role_desc','$role_status')" ;
		
		if(mysqli_query($db,$sql_roll))
		{
			$sql = "select MAX(role_id) AS max from ".$db_suffix."role limit 1";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Create Role <small>Here new User Roles can be created</small>
                                        </h3>
                                        <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey='.$pKey; ?>">Add New Role</a>
                                                </li>
                                        </ul>
                          ...
                          <div class="alert alert-<?php echo $alert_type; ?> <?php echo $alert_box_show; ?>">
                            ...
                            <?php echo $alert_message; ?>
                              ...
                              <div class="col-md-9">
                                 ...
                                 <?php
						$query = "select m.module_id,m.module_name,0 as status from ".$db_suffix."module m ";				
