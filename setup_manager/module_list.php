<?php
	...
	$sql = "SELECT * FROM ".$db_suffix."module ORDER BY module_priority ASC";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                <?php echo $menus["$mKey"]["$pKey"]; ?> <small>The list of Modules already created</small>
                                        </h3>
                                        <div class="page-bar">         
            ...
            <div class="col-md-12">
               ...
               <div class="portlet box grey-cascade">
                  <div class="portlet-title">
                     <div class="caption"><i class="fa fa-table"></i>Modules List</div>
                     <div class="actions">
                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=addmodule'; ?>" class="btn blue"><i class="fa fa-plus"></i> Add new Module</a>
                        <div class="btn-group">
		   ...
		   ?>
                           ...
                           <tr class="odd gradeX">
                              <td><input type="checkbox" class="checkboxes" value="<?php echo $row->module_id;?>" /></td>
                              <td><a href="<?php echo '?mKey='.$mKey.'&pKey=updatemodule&module_id='.$row->module_id;?>"><?php echo $row->module_name;?></a></td>
                              
                              <td><?php echo $row->module_title;?></td>
                              
                              <td><?php echo $row->module_key;?></td>
                              
                              <td><?php echo $row->module_image;?></td>
                              
                              <td><?php echo $row->module_priority;?></td>
                              
                              <td>
							  <?php if($row->module_status)
                              ...
                              <!--<td>
                              <a href="<?php echo '?mKey='.$mKey.'&pKey=updatemodule&module_id='.$row->module_id;?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i> Edit</a>
                              
                              <a data-href="<?php echo SITE_URL_ADMIN; ?>setup_manager/delete_module.php?module_id=<?php echo $row->module_id;?>" data-toggle="modal" href="#" data-target="#confirmation" class="btn default btn-xs red delete"><i class="fa fa-trash"></i> Delete</a>
                              </td> -->                              
                           </tr>
    ...
    <script>
				...
				$('#confirmation_all').on('show.bs.modal', function(e) {
					 ...
					 $('input:checkbox[class=checkboxes]:checked').each(function(){
						...
						$.ajax({
							   type: "POST",
							   url:  '<?php echo SITE_URL_ADMIN.'setup_manager/delete_module.php' ; ?>',
							   dataType: "text",
							   data: {id: id},
				...
				$('#confirmation_status').on('show.bs.modal', function(e) {
					 ...
					 var column_name='module_status';
					 
					 var column_id='module_id';
