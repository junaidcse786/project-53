...
{	
	...
	if($err == 0)
	{
		...
		$sql = "INSERT INTO ".$db_suffix."voc_set VALUES ('','$voc_set_title','$voc_set_desc','$voc_set_level', '$voc_set_status')";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Vocabulary Set Manager <small>Here New Vocabulary sets or groups can be created</small>
                                        </h3>
                                        <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey='.$pKey; ?>">Add new Vocabulary Set</a>
                                                </li>
                                        </ul>
