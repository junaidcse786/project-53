<?php 
$id=$_REQUEST["id"];	
$sql = "SELECT * FROM ".$db_suffix."voc WHERE voc_id IN (SELECT voc_id from ".$db_suffix."voc_relation where voc_set_id=".$id.")";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Vocabulary Manager <small>The list of vocabularies already created in this set [<?php echo $_REQUEST["title"]; ?>]</small>
                                        </h3>
                               <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=vocsetlist';?>"><?php echo $menus["$mKey"]["vocsetlist"]; ?></a>
                                                <i class="fa fa-angle-right"></i>
                                                </li>
                                                <li>
                                                        <a href="#">Vocabs in SET [<?php echo $_REQUEST["title"]; ?>]</a>
                                                </li>
                                        </ul>
            ...
            <div class="col-md-12">
               ...
               <div class="portlet box grey-cascade">
                  <div class="portlet-title">
                     <div class="caption"><i class="fa fa-table"></i>Vocabs in this set</div>
                     <div class="actions">
                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=addvoc'.'&id='.$id; ?>" class="btn blue"><i class="fa fa-plus"></i> Add new vocab to this set</a>
                        <div class="btn-group">
