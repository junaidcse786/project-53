...
$sql = "select * from ".$db_suffix."question q
		Left Join ".$db_suffix."exercise u on u.exercise_id=q.exercise_id where q.question_id = $id limit 1";				
...
if(mysqli_num_rows($query) > 0)
{
	...
	$question_pick      = $content->question_pick;
	$question_type    = $content->question_type;
	$question_marks = $content->question_marks;
	$question_answer  = $content->question_answer;
	$question_case  = $content->question_case;
	$question_group  = $content->question_group;
...
{	
	...
	if($err == 0)
	{
		...
		$sql = "UPDATE ".$db_suffix."question SET question_pick='$question_pick', question_title='$question_title', question_desc='$question_desc', question_type='$question_type', question_answer='$question_answer', exercise_id='$exercise_id', question_marks='$question_marks', question_case='$question_case', question_group='$question_group' where question_id='$id'";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <h3 class="page-title">
                                                Question Manager <small>Here existing questions can be altered</small>
                                        </h3>
                                        <div class="page-bar">         
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=questionlist&id='.$exercise_id.'&title='.$exercise_title; ?>">Questions List in <?php echo $exercise_title; ?></a>
                                                        <i class="fa fa-angle-right"></i>
                                                </li>
                                                <li>
               ...
               <div class="portlet box grey-cascade">
                  <div class="portlet-title">
					 ...
					 <?php 
					 	...
					 	echo '<a target="_blank" href="'.SITE_URL.'exercise-trial/'.$exercise_id.'/'.$exercise_title.'/'.$id.'" class="btn default blue-ebonyclay"><i class="fa fa-video-camera"></i> Preview</a>'; 
                          ...
                          <div class="alert alert-<?php echo $alert_type; ?> <?php echo $alert_box_show; ?>">
                            ...
                            <?php echo $alert_message; ?>
                              ...
                              <div class="form-group <?php echo $messages["question_desc"]["status"] ?>">
                              		...
                              		<div class="col-md-9">
                                 		<textarea class="form-control ckeditor" rows="6" name="question_desc"><?php echo htmlspecialchars($question_desc); ?></textarea>
                              ...
                              <div class="form-group  <?php echo $messages["question_answer"]["status"] ?>">
                              		...
                              		<div class="col-md-9">
                                 		<textarea rows="6" class="form-control" name="question_answer"><?php echo $question_answer; ?></textarea>
